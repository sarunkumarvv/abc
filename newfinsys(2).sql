...
--
-- Dumping data for table `app1_addtax1`
--

INSERT INTO `app1_addtax1` (`addtax1id`, `taxname`, `description`, `cid_id`) VALUES
(1, 'servise tax', 'This is servise tax\n', 16),
(2, 'Income tax', 'This is income tax\n', 16);
...
CREATE TABLE `app1_expenseaccount` (
  ...
  `type1` varchar(100) DEFAULT 'Journal',
  `memo1` varchar(100) DEFAULT 'Service Charge',
  `cid_id` int(11) NOT NULL,
  `expaccountypid_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `app1_expenseaccount`
--

INSERT INTO `app1_expenseaccount` (`expenseid`, `account`, `begbal`, `endbal`, `enddate`, `dat`, `serchar`, `expacc`, `type1`, `memo1`, `cid_id`, `expaccountypid_id`) VALUES
(1, 'Inventory', '100', '200', '11/17/22', '11/17/22', '500', 'Advertising/Promotional', 'Journal', 'Service Charge', 16, 1);
...
CREATE TABLE `app1_incomeaccount` (
  ...
  `type2` varchar(100) DEFAULT 'Deposit',
  `memo2` varchar(100) DEFAULT 'Interest Earned',
  `cid_id` int(11) NOT NULL,
  `expenceincomeid_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `app1_incomeaccount`
--

INSERT INTO `app1_incomeaccount` (`incomeid`, `dat1`, `intear`, `incacc`, `type2`, `memo2`, `cid_id`, `expenceincomeid_id`) VALUES
(1, '11/17/22', '1000', 'Finance Charge Income', 'Deposit', 'Interest Earned', 16, 1);
...
--
-- Dumping data for table `app1_recordpay`
--

INSERT INTO `app1_recordpay` (`recordpayid`, `textname`, `paymentdate`, `recordamount`, `recordmemo`, `cid_id`) VALUES
(1, 'sample mem', '44', 'tjjj\n', '11/17/22', 16);
...
--
ALTER TABLE `app1_addtax1`
  MODIFY `addtax1id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `app1_recordpay`
  MODIFY `recordpayid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
